...
def analyze_data(df):
    ...
    np.save(r'C:\Users\Abdulaziz\Desktop\10 Academy\TellCo mobile service provider\less_engaged_centroid.npy', kmeans.cluster_centers_[0])
    np.save(r'C:\Users\Abdulaziz\Desktop\10 Academy\TellCo mobile service provider\worst_experience_centroid.npy', kmeans.cluster_centers_[1])
